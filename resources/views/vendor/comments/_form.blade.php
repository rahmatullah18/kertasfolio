        ...
        <form method="POST" action="{{ route('comments.store') }}">
            ...
            @if(isset($guest_commenting) and $guest_commenting == true)
                <div class="form-group">
                    <label for="message">Masukan Nama :</label>
                ...
                <div class="form-group">
                    <label for="message">Masukan Email:</label>
            ...
            <div class="form-group">
                <label for="message">Masukan Komentar Anda :</label>
            ...
            <button type="submit" class="btn btn-sm btn-primary text-uppercase">Kirim</button>
        </form>
    </div>
</div>
<br />